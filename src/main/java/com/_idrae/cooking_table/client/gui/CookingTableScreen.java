...
@OnlyIn(Dist.CLIENT)
public class CookingTableScreen extends ContainerScreen<CookingTableContainer> implements IRecipeShownListener {
    private static final ResourceLocation EXAMPLE_BLOCK_GUI_TEXTURES = new ResourceLocation(CookingTableMod.MOD_ID, "textures/gui/cooking_table.png");
    private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation("textures/gui/recipe_button.png");
    private final CookingTableRecipeBookGui recipeBookGui = new CookingTableRecipeBookGui();
    private boolean widthTooNarrow;

    public CookingTableScreen(CookingTableContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.font.drawString(new TranslationTextComponent("container.cooking_table").getUnformattedComponentText(), 28.0F, 6.0F, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.minecraft.getTextureManager().bindTexture(EXAMPLE_BLOCK_GUI_TEXTURES);
        int i = this.guiLeft;
    ...
    protected boolean hasClickedOutside(double mouseX, double mouseY, int guiLeftIn, int guiTopIn, int mouseButton) {
        ...
        return this.recipeBookGui.isMouseInsideGUI(mouseX, mouseY, this.guiLeft, this.guiTop, this.xSize, this.ySize, mouseButton) && flag;
    }
    ...
    public CookingTableRecipeBookGui getRecipeGui() {
